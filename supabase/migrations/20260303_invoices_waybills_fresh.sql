...
CREATE INDEX idx_waybills_customer_id ON waybills(customer_id);
CREATE INDEX idx_waybills_supplier_id ON waybills(supplier_id);
CREATE INDEX idx_waybills_waybill_date ON waybills(waybill_date);
