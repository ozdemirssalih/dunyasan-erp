...
export default function RegisterPage() {
  ...
  const getPasswordStrength = () => {
    ...
    if (password.length < 6) return { strength: 25, label: 'Çok Zayıf', color: 'bg-red-500' }
    if (password.length < 8) return { strength: 50, label: 'Zayıf', color: 'bg-orange-500' }
    if (password.length < 12) return { strength: 75, label: 'İyi', color: 'bg-yellow-500' }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
            DÜNYASAN ERP<br />Sistemine<br />Hoş Geldiniz
          </h1>

          <p className="text-xl text-blue-100 mb-12 leading-relaxed">
            Modern üretim yönetim sistemi ile işlerinizi dijitalleştirin.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-white font-semibold text-lg">Üretim Takibi</h3>
                <p className="text-blue-200">Gerçek zamanlı üretim ve sipariş yönetimi</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-white font-semibold text-lg">CNC Tezgah Yönetimi</h3>
                <p className="text-blue-200">Makine verimliliği ve kapasite takibi</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-white font-semibold text-lg">Güvenli & Hızlı</h3>
                <p className="text-blue-200">Rol bazlı yetkilendirme ve şifreleme</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Bilgilerinizi girerek başlayın</p>
            </div>
