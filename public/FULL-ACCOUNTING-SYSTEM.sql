...
-- ================================================================
-- 4. ÇEK YÖNETİMİ (Alınan/Verilen Çekler)
-- ================================================================
CREATE TABLE checks (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID NOT NULL REFERENCES companies(id) ON DELETE CASCADE,
...
-- ================================================================
-- 5. SENET YÖNETİMİ (Alınan/Verilen Senetler)
-- ================================================================
...
BEGIN
    ...
    RAISE NOTICE '✅ KAPSAMLI MUHASEBE SİSTEMİ OLUŞTURULDU!';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '   3. payments - Ödeme kayıtları';
    RAISE NOTICE '   4. checks - Çek yönetimi (Alınan/Verilen)';
    RAISE NOTICE '   5. promissory_notes - Senet yönetimi (Alınan/Verilen)';
